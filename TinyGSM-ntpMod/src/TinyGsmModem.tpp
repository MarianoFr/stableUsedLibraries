...
class TinyGsmModem {
 public:
  ...
  bool waitForNetwork(uint32_t timeout_ms = 30000L, bool check_signal = false) {
 ...
 protected:
  ...
  bool testATImpl(uint32_t timeout_ms = 20000L) {
 ...
 protected:
  ...
  bool waitForNetworkImpl(uint32_t timeout_ms   = 30000L,
